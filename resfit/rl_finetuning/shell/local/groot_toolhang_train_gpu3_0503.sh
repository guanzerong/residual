...
"${PYTHON_BIN}" -u -m resfit.rl_finetuning.scripts.train_residual_td3 \
  --config-name=residual_td3_toolhang_config \
  ...
  base_policy.groot_base_image_key=observation.images.sideview \
  ...
  save_video=false \
  wandb.project=robomimic-toolhang-groot-residual-td3 \
  wandb.name=toolhang_macro1248_grootn15_ckpt20000_off50_grootfeat_img224_0503_gpu3 \
